...
# Shared constants — also imported by evaluate.py and monitor.py
...
def train():
    ...
    # 2. Stratified split — preserves class balance in train/val/test
    ...
    # 4. Class weights — compensate for class imbalance automatically
